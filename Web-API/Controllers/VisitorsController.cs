...
namespace Web_API.Controllers
{
    ...
    public class VisitorsController : ControllerBase
    {
        ...
        public VisitorsController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Visitor>> PostVisitor(Visitor visitor)
        {
            ...
            return CreatedAtAction(nameof(GetVisitor), new { id = visitor.Passport_Number }, visitor);
        }
        ...
        {
            return _context.Visitors.Any(e => e.Passport_Number == id);
        }
    }
}
